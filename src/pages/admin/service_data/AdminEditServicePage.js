...
const AdminEditServicePage = () => {
  ...
  const getDataById = async () => {
    const {data} = await axios.get(`http://localhost:5001/api/service/${service_id}`)

    setNewServiceName(data.service_type)
    setNewServiceDescription(data.service_description)
    setNewServicePrice(data.service_price)
    setNewServiceWarranty(data.service_warranty)
    setNewServiceWarrantyDescription(data.warranty_description)
    setNewServiceSeasonSpringCheckBox(data.service_season_spring)
    setNewServiceSeasonSummerCheckBox(data.service_season_summer)
    setNewServiceSeasonFallCheckBox(data.service_season_fall)
    setNewServiceSeasonWinterCheckBox(data.service_season_winter)
}
getDataById()
...
const updateHandler = async (e) => {
  ...
  await axios.put(`http://localhost:5001/api/service/${service_id}`, data)
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4">
                ...
                <div className="mt-1">
                  <textarea
                    ...
                    value={newServiceWarrantyDescription}
                    onChange={(e) =>
              ...
              <div className="mt-1 sm:mt-1 sm:col-span-2">
                <div className="ml-3 flex items-center h-5">
                  ...
                  <input
                    ...
                    value={newServiceSeasonSpringCheckBox}
                    onChange={(e) => {
                  ...
                  <input
                    ...
                    type="checkbox"
                    className="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded"
                    value={newServiceSeasonSummerCheckBox}
                    onChange={(e) => {
                      if (e.target.checked === true) {
                ...
                <div className="ml-3 flex items-center h-5 mt-2">
                  ...
                  <input
                    ...
                    type="checkbox"
                    className="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded "
                    value={newServiceSeasonFallCheckBox}
                    onChange={(e) => {
                      if (e.target.checked === true) {
                  ...
                  <input
                    ...
                    type="checkbox"
                    className="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded "
                    value={newServiceSeasonWinterCheckBox}
                    onChange={(e) => {
                      if (e.target.checked === true ) {
