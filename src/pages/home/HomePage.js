...
const faqs = [
  {
    ...
    answer:
      "We're glad you asked. We only hire skilled, experienced employees for each department",
  }, {
    id: 2,
    question: "Why choose us?",
    answer:
...
const stats = [
  { name: 'Gallons of Water', stat: '15,897' },
  { name: 'Carbon footprint saved', stat: '1.009lbs' },
  { name: 'Saved after mower, weedwhacker, blower purchase and maintenance', stat: '23.00 monthly' },
]
...
const HomePage = () => {
  ...
  <div className='container mx-auto'>
      <h3 className="text-lg leading-6 font-medium text-gray-900 ">Customers Save on Average</h3>
    ...
    <div className="relative bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center">
          <h2 className="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">Our Services</h2>
          <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
            You'll be hard pressed to find a company that can provide all these services at top notch quality.
          </p>
        </div>
